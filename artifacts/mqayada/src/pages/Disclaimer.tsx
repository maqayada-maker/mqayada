...
const sections = [
  {
    ...
    content: [
      "منصة مقايضة وسيط إلكتروني تقتصر وظيفته على ربط طالبي التمويل بمستشارين ماليين معتمدين، دون أن تكون طرفاً في أي عملية تمويلية وفق تعريف نظام مراقبة شركات التمويل الصادر بالمرسوم الملكي رقم (م/51) لعام 1433هـ.",
      "جارٍ العمل على الحصول على الترخيص النظامي بعد الفوز في هاكاثون أمد، والمنصة في مرحلتها الحالية مقدَّمة لغرض المسابقة فقط.",
