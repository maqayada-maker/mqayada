  ...
  return <div id="slide-3" ref={outerRef} className="w-screen h-screen overflow-hidden relative" style={{
    backgroundColor: "#000"
      ...
      top: layout.y + "px"
        ...
        ...({ "--pptx-font-scale": "0.828" } as React.CSSProperties),
        wordWrap: "break-word"
      }}><p style={{
          textAlign: "right",
          lineHeight: "0.96",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "700",
            color: "#032341"
          }}>{"07"}</span></p></div><div key={16} style={{
        position: "absolute",
        left: "352.55px",
        top: "399.08px",
        width: "218.83px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontFamily: "'IBM Plex Sans Arabic', sans-serif",
            color: "#032341"
          }}>{"لماذا نحن مختلفون"}</span></p></div><div key={17} style={{
        position: "absolute",
        left: "579.36px",
        top: "399.08px",
        width: "40.31px",
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            fontWeight: "700",
            color: "#032341"
          }}>{"08"}</span></p></div><img key={15} src={img_1} alt="Google Shape;92;p15" style={{
        position: "absolute",
        left: "31.19px",
        top: "18.7px",
        width: "87.06px",
