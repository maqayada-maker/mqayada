        ...
        height: "130.43px"
          ...
          wordWrap: "break-word"
            ...
            marginBottom: "0"
              ...
              fontWeight: "500",
              color: "#8980BC"
            }}>{"\u0645\u0627 \u0646\u062D\u062A\u0627\u062C \u0625\u0644\u0649 \u0627\u0644\u0645\u0633\u0627\u0639\u062F\u0629 \u0641\u064A\u0647:"}</span></p><p style={{
            textAlign: "justify",
            lineHeight: "1.38",
            marginTop: "12pt",
            ...
            marginBottom: "0"
              ...
              fontFamily: "'IBM Plex Sans Arabic', sans-serif",
              color: "#C36B4E"
            }}>{" نحتاج إلى مستثمرٍ داعم للحصول على رخصة مزاولة الوساطة الرقمية، وربطٍ آمن مع البنوك للتحقّق من الدخل (Open Banking) وفق متطلبات البنك المركزي."}</span></p></div><img key={1} src={img_2} alt="Google Shape;232;p25" style={{
          position: "absolute",
          left: "192.04px",
          top: "0px",
          width: "130.43px",
        ...
        height: "130.43px"
          ...
          wordWrap: "break-word"
            ...
            marginBottom: "0"
              ...
              fontFamily: "'IBM Plex Sans Arabic', sans-serif",
              color: "#C36B4E"
            }}>{" التحقق من البيانات المالية دون ربطٍ مباشر بالبنوك حالياً، وبناء الثقة التنظيمية لإطلاق المنصة فعلياً."}</span></p></div><img key={1} src={img_2} alt="Google Shape;235;p25" style={{
          position: "absolute",
          left: "129.22px",
          top: "0px",
          width: "130.43px",
        ...
        height: "130.43px"
          ...
          wordWrap: "break-word"
            ...
            marginBottom: "0"
              ...
              fontWeight: "500",
              color: "#8980BC"
            }}>{"\u0627\u0644\u062E\u0637\u0637 \u0627\u0644\u0645\u0633\u062A\u0642\u0628\u0644\u064A\u0629:"}</span><br /><span style={{
              fontSize: "calc(11pt * var(--pptx-font-scale, 1))",
              fontFamily: "'IBM Plex Sans Arabic', sans-serif",
              color: "#C36B4E"
            }}>{" خارطة الطريق: التكامل مع Open Banking، وتقارير وتحليلات أعمق بالذكاء الاصطناعي، والانتقال من البيئة التجريبية إلى ترخيصٍ تشغيلي كامل."}</span></p></div><img key={1} src={img_2} alt="Google Shape;238;p25" style={{
          position: "absolute",
          left: "202.26px",
          top: "0px",
          width: "130.43px",
