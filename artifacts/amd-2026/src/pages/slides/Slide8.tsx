      ...
      top: layout.y + "px"
        ...
        wordWrap: "break-word"
          ...
          marginBottom: "0"
            ...
            color: "#C36B4E"
          }}>{"يقدّم العميل بياناته المالية مرة واحدة عبر نموذجٍ موحّد، فتطابقها المنصة آلياً مع قواعد تسعير الجهات وتُشعِر المستشارين المناسبين، ثم يحلّل المساعد الذكي العروض لتسهيل المقارنة واتخاذ القرار."}</span></p><p style={{
          textAlign: "right",
          lineHeight: "1.38",
          fontSize: "calc(12pt * var(--pptx-font-scale, 1))",
          marginTop: "0",
